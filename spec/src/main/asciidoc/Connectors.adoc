...
for EIS connections. For example, _jakarta.sql.DataSource_ and
...
The JDBC interfaces— _jakarta.sql.DataSource_ ,
...
server provides the implementation of _jakarta.sql.DataSource_ interface.
...
_jakarta.naming.Referenceable_ interface. Refer to section
...
a Jakarta Transactions _jakarta.transaction.xa.XAResource_ based
