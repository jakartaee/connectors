:sectnums:
= Jakarta EE Connector Architecture, Version 1.7
...
The Java™ Platform, Enterprise Edition (JavaTM
...
The Java EE Connector architecture defines a
...
The connector architecture also defines a
