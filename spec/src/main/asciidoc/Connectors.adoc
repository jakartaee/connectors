...
The Java EE platform specification (see
link:conn.html#a9737[See Java Platform, Enterprise Edition (Java
...
Enterprise JavaBeans specification (see link:conn.html#a9723[See
...
link:conn.html#a4517[See Metadata Annotations]) are used to
...
Wombat buys a Java EE based application server
...
link:conn.html#a4581[See @Connector]. The ResourceAdapter class
must be a JavaBean. Refer to link:conn.html#a5071[See JavaBean
...
link:conn.html#a1891[See Work Management]), and setting up
...
multiple JavaTM Virtual Machineslink:#a10023[2]. In general,
...
link:conn.html#a1891[See Work Management]). The start method
...
to link:conn.html#a588[See Connection Management]),
ActivationSpec JavaBean (refer to link:conn.html#a2576[See
...
link:conn.html#a588[See Connection Management] for more details
...
contract (refer to link:conn.html#a1891[See Work Management]) to
...
=== [[a446]]ActivationSpec JavaBean and Inbound Communication
...
Refer to link:conn.html#a2576[See Message Inflow] for more
...
link:conn.html#a1891[See Work Management]) to request threads to
do work.
...
instances (link:conn.html#a2747[See Administered Objects]) per
resource adapter instance.
...
=== [[a496]]ResourceAdapter JavaBean Instance Configuration
...
deployment descriptors as specified in link:conn.html#a4531[See
...
=== [[a502]]ManagedConnectionFactory JavaBean Instance Configuration
...
=== [[a516]]JavaBean Validation

The Bean Validation specification (see
...
In the Java EE 6 environment, as specified in
...
=== [[a529]]Configuration Property Attributes
...
descriptor (see link:conn.html#a5430[See Resource Adapter XML
Schema Definition] ) or the _supportsDynamicUpdates_ annotation element
in the _ConfigProperty_ annotation (see link:conn.html#a4675[See
@ConfigProperty] ).
...
link:conn.html#a516[See JavaBean Validation] ), the application
...
Throwing an exception when the field is
updated
...
JavaBean, such as _Password_ (see link:conn.html#a5237[See
...
_ConfigProperty_ annotation (see link:conn.html#a4675[See
...
The goal of the connector architecture is to
...
lines in link:conn.html#a615[See Architecture Diagram: Managed
...
(specified in section link:conn.html#a5427[See Requirements])
and metadata annotations (specified in link:conn.html#a4531[See
...
The CCI (specified in
link:conn.html#a3927[See Common Client Interface]) defines
...
=== [[a619]]Managed Application Scenario
...
underlying EIS. Refer to link:conn.html#a5015[See API
...
link:conn.html#a3927[See Common Client Interface] specifies in
...
Refer section link:conn.html#a813[See ManagedConnection] and
...
link:conn.html#a663[See ConnectionFactory and Connection].
...
physical connections to the EIS (see link:conn.html#a796[See
...
=== [[a663]]ConnectionFactory and Connectionlink:#a10024[3]
...
One goal of the connector architecture is to
...
the above design pattern. Refer to link:conn.html#a3990[See
...
_java.sql.SQLException_ for JDBC (see link:conn.html#a9727[See
...
link:conn.html#a992[See OID: Connection Event Notification].
...
In the connector architecture, a resource
...
link:conn.html#a5426[See OID:Lookup of a ConnectionFactory
Instance from JNDI]].
...
invocation. Refer to link:conn.html#a5222[See ResourceAdapter]
...
The _javax.resource.spi.ConnectionManager_
...
The method _c_ reateManagedConnection creates
...
link:conn.html#a1713[See Security Contract] for more details).
...
=== [[a796]]Connection Pool Implementation
...
(refer to link:conn.html#a1079[See Transaction Management] for
...
link:conn.html#a1079[See Transaction Management].
...
method. link:conn.html#a1854[See ManagedConnection] specifies
...
=== [[a847]]Connection Sharing and Multiple Connection Handles
...
link:conn.html#a1329[See Connection Sharing] for more details.
...
link:conn.html#a1430[See Connection Association] ) or the
dissociation of a lazily associatable _ManagedConnection_ (see
link:conn.html#a1502[See Lazy Connection Association
...
shown in the link:conn.html#a1389[See Scenario: Local
Transaction].
...
Refer to link:conn.html#a1329[See Connection Sharing] for
details.
...
The connector architecture provides an event
...
link:conn.html#a1079[See Transaction Management] discusses local
...
A _javax.resource.spi.ConnectionEvent_ class
...
connection related error. Refer to link:conn.html#a6752[See
...
The connector architecture provides basic
...
The _javax.resource.spi.ManagedConnection_
...
involved in the scenario shown in link:conn.html#a992[See OID:
...
underlying EIS instance. Refer to link:conn.html#a5258[See JNDI
...
connection pool. Refer to link:conn.html#a754[See
...
_ManagedConnection_ instance. Refer to link:conn.html#a1713[See
...
link:conn.html#a1079[See Transaction Management] explains this
step in more detail.
...
link:conn.html#a1854[See ManagedConnection] for details if a
...
(see link:conn.html#a992[See OID: Connection Event
...
link:conn.html#a992[See OID: Connection Event Notification] for
...
requests. See link:conn.html#a1329[See Connection Sharing] for a
...
application code. Refer to section link:conn.html#a5258[See JNDI
...
The following object interactions are
involved in the scenario shown in link:conn.html#a1043[See OID:
...
_javax.resource.spi.ManagedConnectionFactory_
 ...
 _javax.resource.spi.ManagedConnection_
...
management and transaction management, as explained later:
 ...
 _javax.resource.spi.ConnectionEvent_

 _javax.resource.spi.ConnectionEventListener_
...
example, the EJB specification (see link:conn.html#a9723[See
...
The connector architecture defines a
...
a JTA _javax.transaction.xa.XAResource_ based
...
The transaction manager supports a JTA
...
The EJBs X and Y access the ERP and TP system
...
The EJB specification requires an EJB
...
The _javax.resource.spi.Managed_ Connection
...
The JavaTM Transaction API (JTA) (see
link:conn.html#a9725[See Java Transaction API (JTA)
...
The JavaTM Transaction Service (JTS) API is a
...
Out of the scope of the connector
...
A full JTA compliant _XAResource_
...
X/Open (see link:conn.html#a9729[See X/Open CAE Specification --
...
The TM is not required to record in a stable
...
The runtime scenario begins with a client
...
The EJB instance calls the _getConnection_
...
=== Scenario: Connection Close and JTA Transactional Cleanup
...
After the JTA transaction completes, the
...
Assuming that all resource manager instances
...
The _javax.resource.spi.LocalTransaction_
...
An EJB component with bean managed
...
In this scenario, the EJB component has
...
However, a Java EE application component that
...
link:conn.html#a9741[See Java Servlet Specification, version
...
In addition, Java EE product providers must
...
The connector architecture has an additional
...
Within a transaction, an EJB component
...
Within a transaction, EJB component A
...
Within a transaction, EJB A acquires a
...
In this scenario, two EJB components get
...
This chapter specifies the security
...
Extend the end-to-end security model for Java
...
Keep the security model for connector
...
A resource adapter must not implement or require a mixture of Jakarta
and Java EE packages. If a resource adapter provider wishes to implement
both specifications, it must do so by providing multiple _RAR_ files.
